...
} from "@/ui/lib/tiptap-utils";

// --- Icons ---
import { HeadingOneIcon } from "@/ui/components/tiptap-icons/heading-one-icon";
import { HeadingTwoIcon } from "@/ui/components/tiptap-icons/heading-two-icon";
import { HeadingThreeIcon } from "@/ui/components/tiptap-icons/heading-three-icon";
import { HeadingFourIcon } from "@/ui/components/tiptap-icons/heading-four-icon";
import { HeadingFiveIcon } from "@/ui/components/tiptap-icons/heading-five-icon";
import { HeadingSixIcon } from "@/ui/components/tiptap-icons/heading-six-icon";
