...
// --- Hooks ---
import { useComposedRef } from "@/ui/hooks/use-composed-ref";

// --- Icons ---
import { ArrowRightIcon } from "@/ui/components/tiptap-icons/arrow-right-icon";
import { CaseSensitiveIcon } from "@/ui/components/tiptap-icons/case-sensitive-icon";
import { ChevronDownIcon } from "@/ui/components/tiptap-icons/chevron-down-icon";
import { ChevronUpIcon } from "@/ui/components/tiptap-icons/chevron-up-icon";
import { CloseIcon } from "@/ui/components/tiptap-icons/close-icon";
import { ExternalLinkIcon } from "@/ui/components/tiptap-icons/external-link-icon";
import { SearchIcon } from "@/ui/components/tiptap-icons/search-icon";
import { WholeWordIcon } from "@/ui/components/tiptap-icons/whole-word-icon";

// --- Lib ---
import { cn } from "@/ui/lib/tiptap-utils";

// --- Tiptap UI ---
import type { UseSearchAndReplaceConfig } from "@/ui/components/tiptap-ui/search-and-replace";
import {
...
// --- UI Primitives ---
import type { ButtonProps } from "@/ui/components/tiptap-ui-primitive/button";
import { Button } from "@/ui/components/tiptap-ui-primitive/button";
import { ButtonGroup } from "@/ui/components/tiptap-ui-primitive/button-group";
import {
  Card,
  CardBody,
  CardFooter,
  CardHeader,
} from "@/ui/components/tiptap-ui-primitive/card";
import {
  InputGroup,
  InputGroupAddon,
  InputGroupInput,
} from "@/ui/components/tiptap-ui-primitive/input-group";
import { Separator } from "@/ui/components/tiptap-ui-primitive/separator";
import { Switch } from "@/ui/components/tiptap-ui-primitive/switch";

// --- Styles ---
import "@/ui/components/tiptap-ui/search-and-replace/search-and-replace.scss";
